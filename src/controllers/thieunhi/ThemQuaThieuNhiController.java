...
public class ThemQuaThieuNhiController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ObservableList<String> namThieuNhi = FXCollections.observableArrayList("2017", "2018", "2019", "2020", "Khác");
        this.themNamThieuNhi.setItems(namThieuNhi);
        ObservableList<String> dipThieuNhi = FXCollections.observableArrayList("Tết dương lịch", "Tết Nguyên Đán", "Tết thiếu nhi", "Trung Thu", "Noel", "Khác");
        this.themDipThieuNhi.setItems(dipThieuNhi);
    }
    ...
    public void themDipThieuNhi(ActionEvent event) {
        this.dipThieuNhi = this.themDipThieuNhi.getSelectionModel().getSelectedItem().toString();
    }

    public void themNamThieuNhi(ActionEvent event) {
        this.namThieuNhi = Integer.parseInt(this.themNamThieuNhi.getSelectionModel().getSelectedItem().toString());
    }
